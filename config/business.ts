...
const FALLBACK_USD_ZAR_RATE = 16.0413;
...
export const BUSINESS_CONFIG = Object.freeze({
  ...
  commerce: Object.freeze({ vatDisplayMode: vatMode(process.env.VAT_DISPLAY_MODE), pricingRateUpdatedAt: optional(process.env.PRICING_RATE_UPDATED_AT) }),
