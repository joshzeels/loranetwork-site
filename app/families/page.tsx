...
export default function FamiliesPage() {
  return <>
    <section className="page-hero"><div className="shell page-hero-grid"><div><h1>Compare related models.</h1></div><div className="page-hero-aside"><p>Explore related products and compare their specifications, interfaces and prices.</p><strong>{productFamilies.length} product families</strong></div></div></section>
